...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-MSI -Action "install" -Path "$dirFiles\MestReNova-10.0.2-15465.msi" -Parameters "reboot=reallysuppress /qn" -PassThru
		...
		Execute-Process "$dirSupportFiles\license.bat"
